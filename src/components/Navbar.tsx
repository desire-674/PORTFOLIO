...
import { FiGithub, FiUser, FiSun, FiMoon, FiMenu, FiX, FiLinkedin } from 'react-icons/fi'
import './Navbar.css'
      ...
      <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="navbar-container">
          ...
          <div className="social-icons">
            <a 
              href="https://github.com/desire-674" 
              target="_blank" 
            ...
            <a 
              href="https://www.linkedin.com/in/sai-ganesh-0853ba259/" 
              target="_blank" 
              rel="noopener noreferrer"
              aria-label="LinkedIn"
            >
